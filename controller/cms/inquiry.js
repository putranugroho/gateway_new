...
router.post('/acct', validateApiKey, async (req, res) => {
    ...
    response = await callAPI(URL_CMS, "gw/inq/acct", req.body, header)
...
router.post('/validatenorek', validateApiKey, async (req, res) => {
    ...
    response = await callAPI(URL_CMS, "gw/inq/validatenorek", req.body, header)
...
router.post('/validatenohp', validateApiKey, async (req, res) => {
    ...
    printreq(req.body, "VALIDATE NOREK");
    response = await callAPI(URL_CMS, "gw/inq/validatenohp", req.body, header)
    printres(response, "VALIDATE NOREK");
    res.status(200).send(response);
});
...
router.post('/validatekeeping', validateApiKey, async (req, res) => {
    ...
    response = await callAPI(URL_CMS, "gw/inq/validatekeeping", req.body, header)
...
router.post('/validatenorekhp', validateApiKey, async (req, res) => {
    ...
    response = await callAPI(URL_CMS, "gw/inq/validatenorekhp", req.body, header)
...
router.post('/cekktp', validateApiKey, async (req, res) => {
    ...
    response = await callAPI(URL_CMS, "gw/inq/cekktp", req.body, header)
...
router.post('/limitacctype', validateApiKey, async (req, res) => {
    ...
    response = await callAPI(URL_CMS, "gw/inq/ceklimit", req.body, header)
