...
router.post("/all", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/all", req.body, {
...
router.post("/logout", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/logout", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/login", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/login", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/otorisasi", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/otorisasi", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/getlistotor", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/getlistotor", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/byname", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/byname", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/user", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/user", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/add", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/add", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/chg", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/chg", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/validasi", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "userid/validasi", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
