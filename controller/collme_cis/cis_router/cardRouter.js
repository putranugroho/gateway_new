...
router.post("/insert", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "card/insert", req.body, {
...
router.post("/getall", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "card/getall", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/updatests", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "card/updatests", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
