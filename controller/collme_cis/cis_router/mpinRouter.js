...
router.post("/generate", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "mpin/generate", req.body, {
...
router.post("/getlist", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "mpin/getlist", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/reset", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "mpin/reset", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/check", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "mpin/check", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/cetak", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "mpin/cetak", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/chg", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "mpin/chg", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
...
router.post("/val", validateApiKey, async (req, res) => {
  ...
  response = await callAPI(URL_COLLME, "mpin/val", req.body, {
    "x-api-key": "X0pQMBDSo2DAarIgOQrbm/N/UySKrbPeo3QbnZkKD7M=",
  });
